...
app.post('/ai/summarize', async (req, res) => {
  try {
    ...
    switch (summaryLength) {
      case 'short':
        prompt = `Please provide a brief, 1-2 sentence summary of the following text:\n\n"${text}"`;
        break;
      case 'long':
        prompt = `Please provide a detailed summary of the following text, covering all main points:\n\n"${text}"`;
        break;
      default:
